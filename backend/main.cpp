...
{
    string name;
    cout << "Enter username to accept request: ";
    cin >> name;
...
{
    string name;
    cout << "Enter username to reject request: ";
    cin >> name;
...
void handleFollowingList()
{
    ...
    {
        cout << "Not following anyone." << endl;
    }
    else
    {
...
void handleLikePost()
{
    string name;
    int postID;
    cout << "Enter username whose post to like: ";
    cin >> name;
    cout << "Enter Post ID: ";
    cin >> postID;
...
void handleCommentPost()
{
    string name, comment;
    int postID;
    cout << "Enter username whose post to comment on: ";
    cin >> name;
    cout << "Enter Post ID: ";
    cin >> postID;
    cout << "Enter comment: ";
